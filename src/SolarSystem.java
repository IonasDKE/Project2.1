...
public class SolarSystem extends CelestialBody{
    ...
    public SolarSystem(){
        ...
        planetaryObjects = new ArrayList<>();
    ...
    void firstUpdate(ArrayList<CelestialBody> listOfObritalObjects) {
        for (int i=0;i<listOfObritalObjects.size();i++) {
            ...
            listOfObritalObjects.get(i).oldX =listOfObritalObjects.get(i).x+ timestep * c1*listOfObritalObjects.get(i).velX;
            listOfObritalObjects.get(i).oldY =listOfObritalObjects.get(i).y+ timestep * c1*listOfObritalObjects.get(i).velY;

        }
    }
    void secondUpdate(ArrayList<CelestialBody> listOfObritalObjects) {
        ...
        for (int i = 0; i < listOfObritalObjects.size(); i++) {
            ...
            listOfObritalObjects.get(i).accX = 0;
    ...
    void fourthUpdate(ArrayList<CelestialBody> listOfObritalObjects) {
        for (int i=0;i<planetaryObjects.size();i++) {
    ...
    void fifthUpdate(ArrayList<CelestialBody> listOfObritalObjects) {
    ...
    void sixthUpdate(ArrayList<CelestialBody> listOfObritalObjects) {
    ...
    void eightUpdate(ArrayList<CelestialBody> listOfObritalObjects) {
        // a -> a(x_i_3)
        double dx, dy, dz, D, A;
    ...
    void ninethUpdate(ArrayList<CelestialBody> listOfObritalObjects) {
    ...
    */
    ...
    void updatePositions(){
        ...
        fourthUpdate(planetaryObjects);
        fifthUpdate(planetaryObjects);
        sixthUpdate(planetaryObjects);
        seventhUpdate(planetaryObjects);
